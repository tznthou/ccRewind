...
- **The file index docs omitted a fourth operation**: Glob and Grep are recorded as `discovery`, where the docs listed only read/edit/write. The index also does not parse the contents of Bash commands, which had gone unmentioned
